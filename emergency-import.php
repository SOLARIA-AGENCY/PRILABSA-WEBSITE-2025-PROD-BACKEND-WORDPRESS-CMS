<?php
/**
 * Emergency Product Import Script
 * Access: https://productos.prilabsa.com/wp-admin/admin.php?import_prilabsa=SECRET_KEY_2025
 */

// Security check
if (!isset($_GET['import_prilabsa']) || $_GET['import_prilabsa'] !== 'SECRET_KEY_2025') {
...
echo "=== PRILABSA Emergency Product Import ===\n";
