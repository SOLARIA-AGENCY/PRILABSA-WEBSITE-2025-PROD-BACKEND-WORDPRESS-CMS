import { u as useLanguage, n as noticiasData, j as jsxRuntimeExports, L as Layout, g as getLocalizedContent, f as getLocalizedTags, B as Breadcrumbs } from "./index.js";
...
const NoticiaPage = () => {
  ...
  if (!article) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-6 py-20 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold text-gray-800 mb-4", children: t("news.newsNotFound") }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Link,
        {
          to: "/noticias",
          className: "text-prilabsa-blue-primary hover:text-prilabsa-blue-secondary transition-colors",
          children: t("news.backToNews")
        }
      )
    ] }) });
  }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto py-12 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-md", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "mb-8 text-center", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 flex flex-wrap justify-center gap-2", children: localizedTags.map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "bg-white text-blue-800 border border-blue-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded-full", children: tag }, tag)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(RelatedArticles, { currentArticleId: article.id, articles: noticiasData, basePath: "/noticias" })
  ] });
};
export {
  NoticiaPage as default
};
