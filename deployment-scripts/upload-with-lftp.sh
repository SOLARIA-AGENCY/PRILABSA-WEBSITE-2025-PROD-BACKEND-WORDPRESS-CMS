...
mkdir -p assets/productos
put dist/assets/productos/AD001_COMBACID_XL.png -o assets/productos/AD001_COMBACID_XL.png
put dist/assets/productos/AD002_Carophyll_Pink.png -o assets/productos/AD002_Carophyll_Pink.png
put dist/assets/productos/AL001_CAMARON_CRECIMIENTO_35.png -o assets/productos/AL001_CAMARON_CRECIMIENTO_35.png
