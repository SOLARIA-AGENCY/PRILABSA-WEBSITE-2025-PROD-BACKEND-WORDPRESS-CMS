    ...
    return (
      <Layout>
        ...
        <div className="container mx-auto py-16 px-4">
          <LoadingLogo message="Cargando artículos..." size="md" />
        </div>
      </Layout>
    );
  }
  ...
  return (
    <Layout>
      ...
      <StaticHero
        title={t('blog.pageTitle')}
        subtitle={t('blog.subtitle')}
        backgroundImage="https://images.pexels.com/photos/3689659/pexels-photo-3689659.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"
      />
      <Breadcrumbs
        paths={[
          { name: t('breadcrumbs.home'), path: '/' },
