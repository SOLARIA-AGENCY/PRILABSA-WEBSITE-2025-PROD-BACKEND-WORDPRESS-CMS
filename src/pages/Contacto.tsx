...
import { sendContactForm, type ContactFormData } from '../services/emailService';
...
const Contacto = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const payload: ContactFormData = { ...formData, consent: consent, consentData };
    ...
    try {
      ...
      if (success) {
        console.log('Email enviado exitosamente via FormSubmit.co');
        setIsSubmitted(true);
        setFormData({ name: '', company: '', email: '', phone: '', message: '' });
        setConsent(false);
      } else {
        setErrors(prev => ({ ...prev, general: 'Hubo un error al enviar el mensaje. Por favor, inténtelo nuevamente.' }));
      }
    } catch (error) {
