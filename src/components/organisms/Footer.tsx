        ...
        <div className="grid md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <Link to="/quienes-somos" className="block text-gray-300 hover:text-blue-400 transition-colors">
                Quienes Somos
              </Link>
              <Link to="/oficinas" className="block text-gray-300 hover:text-blue-400 transition-colors">
                Oficinas
              </Link>
              <Link to="/productos" className="block text-gray-300 hover:text-blue-400 transition-colors">
                Productos
              </Link>
              <Link to="/trabaja-con-nosotros" className="block text-gray-300 hover:text-blue-400 transition-colors">
          ...
          <div>
            ...
            <div className="space-y-3">
              <Link to="/politica-de-privacidad" className="block text-gray-300 hover:text-blue-400 transition-colors">
                Política de Privacidad
              </Link>
              <Link to="/politica-de-cookies" className="block text-gray-300 hover:text-blue-400 transition-colors">
                Política de Cookies
              </Link>
              <Link to="/aviso-legal" className="block text-gray-300 hover:text-blue-400 transition-colors">
                Aviso Legal
              </Link>
              <Link to="/terminos-y-condiciones" className="block text-gray-300 hover:text-blue-400 transition-colors">
