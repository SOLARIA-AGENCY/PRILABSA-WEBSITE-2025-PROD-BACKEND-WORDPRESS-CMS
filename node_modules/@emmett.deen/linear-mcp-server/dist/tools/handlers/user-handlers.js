 ...
 */
export function handleGetViewer(linearService) {
    return async (args) => {
        try {
 ...
 */
export function handleGetOrganization(linearService) {
    return async (args) => {
        try {
 ...
 */
export function handleGetUsers(linearService) {
    return async (args) => {
        try {
 ...
 */
export function handleGetLabels(linearService) {
    return async (args) => {
        try {
