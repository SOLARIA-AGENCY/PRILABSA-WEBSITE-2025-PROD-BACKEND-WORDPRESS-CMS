...
class PRILABSA_ACF_Config
{
	...
	private function get_product_fields()
	{
		return array(
			...
			array(
				...
				'label' => __('Descripción Corta (Español)', 'prilabsa-acf'),
				'name' => 'descripcion_corta_es',
				'type' => 'text',
				'instructions' => __('Breve descripción para listados (Español)', 'prilabsa-acf'),
				'required' => 0,
			...
			array(
				...
				'label' => __('Descripción Corta (Inglés)', 'prilabsa-acf'),
				'name' => 'descripcion_corta_en',
				'type' => 'text',
				'instructions' => __('Short description for listings (English)', 'prilabsa-acf'),
				'required' => 0,
				'wrapper' => array('width' => '33'),
				'show_in_rest' => 1,
			),
			...
			array(
				...
				'label' => __('Descripción Corta (Portugués)', 'prilabsa-acf'),
				'name' => 'descripcion_corta_pt',
				'type' => 'text',
				'instructions' => __('Descrição curta para listagens (Português)', 'prilabsa-acf'),
				'required' => 0,
				'wrapper' => array('width' => '33'),
				'show_in_rest' => 1,
			),
			...
			array(
				...
				'label' => __('Especificaciones (Español)', 'prilabsa-acf'),
				'name' => 'especificaciones_es',
				'type' => 'textarea',
				'instructions' => __('Especificaciones clave-valor (Uno por línea, ej: "Peso: 10kg")', 'prilabsa-acf'),
				'required' => 0,
				'wrapper' => array('width' => '33'),
				'rows' => 6,
				'new_lines' => '', // Raw text for parsing
				'show_in_rest' => 1,
			),
			// Especificaciones (EN)
			array(
				'key' => 'field_especificaciones_en',
				'label' => __('Especificaciones (Inglés)', 'prilabsa-acf'),
				'name' => 'especificaciones_en',
				'type' => 'textarea',
				'instructions' => __('Specifications key-value (One per line, ex: "Weight: 10kg")', 'prilabsa-acf'),
				'required' => 0,
				'wrapper' => array('width' => '33'),
				'rows' => 6,
				'new_lines' => '',
			...
			array(
				...
				'label' => __('Especificaciones (Portugués)', 'prilabsa-acf'),
				'name' => 'especificaciones_pt',
				'type' => 'textarea',
				'instructions' => __('Especificações chave-valor (Um por linha, ex: "Peso: 10kg")', 'prilabsa-acf'),
				'required' => 0,
				'wrapper' => array('width' => '33'),
				'rows' => 6,
				'new_lines' => '',
			...
			// --- FIN CAMPOS TRADUCIDOS ---

			// Field 2: Especificaciones (Repeater) - MAINTAINED FOR BACKWARD COMPATIBILITY
			array(
				'key' => 'field_especificaciones',
				'label' => __('Especificaciones Técnicas (Legacy)', 'prilabsa-acf'),
	...
	private function get_field_schema($field_name)
	{
		$schemas = array(
			...
			'descripcion_corta_es' => array(
				'description' => __('Descripción corta (Español)', 'prilabsa-acf'),
				'type' => 'string',
				'context' => array('view', 'edit', 'embed'),
			),
			'descripcion_corta_en' => array(
				'description' => __('Short description (English)', 'prilabsa-acf'),
				'type' => 'string',
				'context' => array('view', 'edit', 'embed'),
			),
			'descripcion_corta_pt' => array(
				'description' => __('Descrição curta (Português)', 'prilabsa-acf'),
				'type' => 'string',
				'context' => array('view', 'edit', 'embed'),
			),
			'especificaciones_es' => array(
				'description' => __('Especificaciones (Español)', 'prilabsa-acf'),
				'type' => 'string',
				'context' => array('view', 'edit', 'embed'),
			),
			'especificaciones_en' => array(
				'description' => __('Specifications (English)', 'prilabsa-acf'),
				'type' => 'string',
				'context' => array('view', 'edit', 'embed'),
			),
			'especificaciones_pt' => array(
				'description' => __('Especificações (Portugués)', 'prilabsa-acf'),
				'type' => 'string',
				'context' => array('view', 'edit', 'embed'),
			),
